...
function AcceptTask({taskData}) {
  ...
  return (
        ...
        <div  className='h-full w-[400px] p-8 flex-shrink-0 bg-green-800 rounded-2xl'>
            ...
            <div className='mt-5 flex justify-start gap-5 text-[#f9f9f9]'>
                <button className='px-5 py-1 bg-zinc-800 rounded-lg'>Completed</button>
                <button className='px-5 py-1 bg-zinc-800 rounded-lg'>Faild</button>
            </div>
        </div>
